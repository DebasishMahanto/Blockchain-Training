...
contract MarketPlace {
    ...
    function purchase(
        ...
        require(_quantity<tokenOnSaleInfo[_isERC721][_tokenId][_sellerAddress].quantity, "MarketPlace: insufficient token ");
    ...
    function tokenOnAuctionInfo(uint256 _tokenId, bool _isERC721)
        external
        view
    ...
    function setAuction(
        ...
        if (_isERC721) {
            ...
            require(
                IERC1155(erc1155).isApprovedForAll(msg.sender, address(this)),
                "MarketPlace: please approve contract first"
            );
            require(
                (IERC1155(erc1155).balanceOf(msg.sender, _tokenId)) >=
                    _quantity +
    ...
    function cancelBid(uint256 _tokenId, bool _isERC721) external {
        require(
            auctionInfo[_isERC721][_tokenId][msg.sender].isOnAuction,
        ...
        for (
            ...
            if (
                ...
                tempBidAmount = biddingHistory[_isERC721][_tokenId][msg.sender][
                    index
                ].biddingAmount;
                tempAddress = biddingHistory[_isERC721][_tokenId][msg.sender][
                    index
                ].bidderAddress;
                biddingHistory[_isERC721][_tokenId][msg.sender][index]
